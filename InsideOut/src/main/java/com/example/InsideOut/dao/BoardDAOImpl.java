...
public class BoardDAOImpl implements BoardDao {
	...
	public void insertBoard(BoardBean b) throws Exception {
		...
		session.insert("boardns.file_insert", b);
	}
	 ...
	 // 공지 게시물 목록 
	  ...
	  @Override public int getListCount() throws Exception { int count =0; count =
	  ((Integer)session.selectOne("boardns.notice_count")).intValue();
	  ...
	  @Override public void boardHit(int post_no) throws Exception {
	  session.update("boardns.board_hit", post_no); }
	  
	 /* //게시물 수정
	  
	  @Override public void boardEdit(BoardBean b) throws Exception {
	  ...
	  */
	  ...
	  @Override public void boardDelete(int post_no) throws Exception {
