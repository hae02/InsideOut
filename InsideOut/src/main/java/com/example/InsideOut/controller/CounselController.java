...
public class CounselController {
	...
	public String counselBooking(@RequestParam("counsel_typeno") String counsel_typeno, CounselBookingBean cBookingBean,
...
//								  StaffBean staff, Model model) throws Exception {
	...
	// public String counselRecode(String student_no, String booking_no, Model
	// model) throws Exception {
	public String counselRecord(@ModelAttribute CounselBookingBean counselBookingBean, Model model) throws Exception {
	...
	public String counselRecordOk(@ModelAttribute CounselRecordBean counselRecordBean, Model model) throws Exception {
