		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarColor02">
				<ul class="navbar-nav mx-auto">
					<li class="nav-item"><a class="nav-link active" href="/api/v1/student/StudentList" >마이페이지</a></li>
					<li class="nav-item"><a class="nav-link" href="/api/v1/student/counselType">상담예약</a></li>
