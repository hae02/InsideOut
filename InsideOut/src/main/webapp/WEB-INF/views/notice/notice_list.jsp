...
<body>
	...
	<div id="noticelist_wrap" class="container">
				...
				<tr align="center" valign="middle" bordercolor="#333333"
					...
					<td style="font-family: Tahoma; font-size: 10pt;">
						<div align="left">
							...
							<!-- 제목 출력 부분 -->
							<a
								href="board_cont.do?post_no=${b.post_no}&page=${page}&state=cont&board_name=notice">
								${b.post_title} </a>
						</div>
					</td>
		...
		<div id="noticelist_w">
			<input type="button" value="글쓰기" class="input_button"
				onclick="location='staff/board_write.do?page=${page}&board_name=notice'">
