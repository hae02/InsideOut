		...
		<div class="row flex-nowrap">
			<div class="col-3 bd-sidebar">
				<ul class="nav">
					...
					<li><a href="/api/v1/user/AskList">1:1 문의</a></li>
				...
				<table class="table table-bordered">
					...
					<c:forEach items="${recordList}" var="r">
						<tr>
							...
							<td><input type="hidden" id="student_no" name="student_no"
								value="${r.student_no}">${r.student_no}</td>
							<td><input type="hidden" id="booking_no" name="booking_no"
