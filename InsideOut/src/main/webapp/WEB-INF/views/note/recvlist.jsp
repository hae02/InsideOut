...
<%-- 
    ...
    ${note.message}
									...
									<!-- 	<td style="width: 16%; text-align: center;"> -->
										<td>
											<fmt:formatDate value="${note.rcv_dt}" pattern="yyyy.MM.dd" />
										</td>
									</tr>
...
<button type="button" class="btn btn-outline-danger" onClick="location.href='notedelete?note_No=${note.note_no}'">삭제</button>
												</div>
											</div>
										</div>
									</div>
