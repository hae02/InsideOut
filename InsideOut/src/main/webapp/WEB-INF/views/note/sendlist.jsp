...
<head >
    ...
    <style>
        ...
        .navbar-toggler-icon {
            background-image: url("data:image/svg+xml,%3csvg viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3e%3cpath stroke='rgba%28108%2c124%2c195%2c0.5%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
        }
...
<body>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="chat">
                   <%--  <div class="chat-header">
                        <div class="chat-header-user-detail active">
                            <div class="chat-header-avatar">
                                <span>John</span>
                            </div>
                            <span class="chat-header-user-name">${send.send_id}</span>
                        </div>
                    </div> --%>
                   <div class="chat-body">
    ...
    <a href="notesendview?cnt=${send.note_no}&send_id=${send.send_id}">
        ${send.message}
    </a>
</div>
    <%--         <div class="chat-message-date">${send.snd_dt}</div> --%>
